<div class="modal fade leo-modal" id="getServiceCalc" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-body">
                <form id="getServiceCalcForm" class="ajax_form" method="POST">
                    <div>
                        <button class="btn btn-link close-modal" data-dismiss="modal" type="button">
                            <img src="images/icon-close.png" />
                        </button>
                        <span class="blue">
                            Оставьте контакты в форме и мы свяжемся с Вами в течение 2-х минут
                        </span>
                    </div>
