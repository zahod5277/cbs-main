<?php 
/** Fenom template 'file:chunks/infocenter/new/articleFormAndRecommended.tpl' compiled at 2017-04-17 13:07:34 */
        ...
        <div class=" _news nofollow">
            ...
            <div id="k2ModuleBox206" class="k2ItemsBlock _news nofollow">
                <table class="table infocenterRecommendedTable" rules="none">
                        <?php
/* file:chunks/infocenter/new/articleFormAndRecommended.tpl:67: {$_modx->runSnippet('pdoResources',[
                                'parents' => 5009,
                                'includeTVs' => 'atention',
                                'where' => '{"atention:=":"1"}',
                                'limit' => 6,
 ...
 echo $var["_modx"]->runSnippet('pdoResources', array('parents' => 5009, 'includeTVs' => 'atention', 'where' => '{"atention:=":"1"}', 'limit' => 6, 'sortby' => 'createdon', 'sortdir' => 'DESC', 'tpl' => '@FILE:chunks/infocenter/recommendedRow.tpl')); ?>
                </table>
            </div>
        </div>
    </div>
    <?php
/* file:chunks/infocenter/new/articleFormAndRecommended.tpl:72: {include 'file:chunks/infocenter/new/trust.tpl'} */
 $tpl->getStorage()->getTemplate('file:chunks/infocenter/new/trust.tpl')->display($var); ?>
</div>
<?php
/* file:chunks/infocenter/new/articleFormAndRecommended.tpl:74: {include 'file:chunks/infocenter/sendArticleForm.tpl'} */
 $tpl->getStorage()->getTemplate('file:chunks/infocenter/sendArticleForm.tpl')->display($var); ?><?php
}, array(
	'options' => 160,
	'provider' => 'file',
	'name' => 'file:chunks/infocenter/new/articleFormAndRecommended.tpl',
	'base_name' => 'chunks/infocenter/new/articleFormAndRecommended.tpl',
	'time' => 1492423649,
	'depends' => array (
  'file' => 
  array (
    'chunks/infocenter/new/articleFormAndRecommended.tpl' => 1492423649,
  ),
),
	'macros' => array(),
