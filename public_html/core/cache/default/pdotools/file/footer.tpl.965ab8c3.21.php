<?php 
/** Fenom template 'file:chunks/common/footer.tpl' compiled at 2017-04-07 16:55:16 */
...
<div class="container outside-footer hidden-print">
    ...
    <div class="row">
        <div class="footer">
            <div class="col-xs-5">
                <div>
                    <a class="RobotoBold" style="color:#000;" href="/">
                        CBS GROUP
                    </a>
                </div>
                <div class="footer_copyright">
                    <span class="RobotoLight">
                        <span class="all_rights">Все права защищены &copy; 2017</span>
                        <br>
                        <a href="#" data-target="#copyright-modal" data-toggle="modal">Политика конфиденциальности</a>
                    </span>

                    <span class="fivelands">
                        <a href="<?php
/* file:chunks/common/footer.tpl:20: {$_modx->makeUrl(42)} */
 echo $var["_modx"]->makeUrl(42); ?>" rel="nofollow" target="_blank">Разработка сайта
                           <br/> CBS group design
                        </a>
                    </span>
                    <div class="modal fade leo-modal" id="copyright-modal" role="dialog" tabindex="-1">
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div>
                                        ...
                                        <span class="blue">Политика конфиденциальности</span>
                                    </div>
            ...
            <div class="col-xs-7">
                <ul class="menu_bottom">
                    <li class="item-125 current active"><a href="/">Главная</a>
                    </li>
                    ...
                    <li class="item-101"><a href="/informaciya-o-kompaniye">О компании</a>
                    </li>
                    <li class="item-258 deeper parent">
                        <a href="/press-centr">Инфо-центр</a>
                        <ul>
                            <li class="item-257">
                    ...
                    <li class="item-142"><a href="/kontakty">Контакты</a>
                    </li>
                </ul>
                <div class="footerShare">
                    <?php
/* file:chunks/common/footer.tpl:127: {include 'file:chunks/common/shareIcons.tpl'} */
...
<!-- /Yandex.Metrika counter --> <?php
	...
	'options' => 160,
	'provider' => 'file',
	'name' => 'file:chunks/common/footer.tpl',
	'base_name' => 'chunks/common/footer.tpl',
	'time' => 1491482635,
	'depends' => array (
  'file' => 
  array (
    'chunks/common/footer.tpl' => 1491482635,
  ),
),
	'macros' => array(),
