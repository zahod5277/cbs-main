<?php 
/** Fenom template 'file:templates/info/infoCategory.tpl' compiled at 2017-04-07 17:01:40 */
...
<body class="tmpl-index itemid-125 menuBody lang-ru com-k2 view-item layout-item task-none zoo-itemid-0 zoo-categoryid-0 device-ios-no device-android-no device-mobile-no device-table-no">
    ...
    <header>
        <?php
/* file:templates/info/infoCategory.tpl:4: {include 'file:chunks/infocenter/new/topmenu.tpl'} */
 $tpl->getStorage()->getTemplate('file:chunks/infocenter/new/topmenu.tpl')->display($var); ?>
    </header>

    
    <?php
/* file:templates/info/infoCategory.tpl:8: {include 'file:chunks/common/breadcrumbs.tpl'} */
 $tpl->getStorage()->getTemplate('file:chunks/common/breadcrumbs.tpl')->display($var); ?>
    <?php
/* file:templates/info/infoCategory.tpl:9: {include 'file:chunks/infocenter/infoCategory.tpl'} */
 $tpl->getStorage()->getTemplate('file:chunks/infocenter/infoCategory.tpl')->display($var); ?>
    <?php
/* file:templates/info/infoCategory.tpl:10: {include 'file:chunks/common/footer.tpl'} */
 $tpl->getStorage()->getTemplate('file:chunks/common/footer.tpl')->display($var); ?>
    <?php
/* file:templates/info/infoCategory.tpl:11: {include 'file:chunks/common/weCallYou.tpl'} */
 $tpl->getStorage()->getTemplate('file:chunks/common/weCallYou.tpl')->display($var); ?>
    <?php
/* file:templates/info/infoCategory.tpl:12: {include 'file:chunks/common/jivoSite.tpl'} */
...
<script>
	...
	'options' => 160,
	'provider' => 'file',
	'name' => 'file:templates/info/infoCategory.tpl',
	'base_name' => 'templates/info/infoCategory.tpl',
	'time' => 1491482635,
	'depends' => array (
  'file' => 
  array (
    'templates/base.tpl' => 1491482635,
    'templates/info/infoCategory.tpl' => 1491482635,
  ),
),
	'macros' => array(),
