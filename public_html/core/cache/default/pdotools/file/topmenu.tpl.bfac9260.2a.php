<?php 
/** Fenom template 'file:chunks/infocenter/new/topmenu.tpl' compiled at 2017-04-07 16:56:28 */
return new Fenom\Render($fenom, function ($var, $tpl) {
?><div class="container">
    <div class="row topmenu">
        <div class="col-xs-4 infocenterLogoWrapper">
            <div class="infocenterLogoInner">
                <div class="visible-print-block">
                    <img src="images/logo.png" title="logo" alt="CBS Group">
                </div>
                <a href="<?php
/* file:chunks/infocenter/new/topmenu.tpl:8: {$_modx->makeUrl(1)} */
 echo $var["_modx"]->makeUrl(1); ?>" class="hidden-print">
                    <img src="images/logo.png" title="logo" alt="CBS Group">
                </a>
            </div>
            <div class="headerLogoMenu">
                <ul>
                    <li><a href="<?php
/* file:chunks/infocenter/new/topmenu.tpl:14: {$_modx->makeUrl(3)} */
 echo $var["_modx"]->makeUrl(3); ?>">Аудит</a></li>
                    <li><a href="<?php
/* file:chunks/infocenter/new/topmenu.tpl:15: {$_modx->makeUrl(5033)} */
 echo $var["_modx"]->makeUrl(5033); ?>">МСФО</a></li>
                    <li><a href="<?php
/* file:chunks/infocenter/new/topmenu.tpl:16: {$_modx->makeUrl(4)} */
 echo $var["_modx"]->makeUrl(4); ?>">Консалтинг</a></li>
                    <li><a href="<?php
/* file:chunks/infocenter/new/topmenu.tpl:17: {$_modx->makeUrl(42)} */
 echo $var["_modx"]->makeUrl(42); ?>">Автоматизация 1С</a></li>
                    <li><a href="<?php
/* file:chunks/infocenter/new/topmenu.tpl:18: {$_modx->makeUrl(48)} */
 echo $var["_modx"]->makeUrl(48); ?>">Аутсорсинг</a></li>
                    <li><a href="<?php
/* file:chunks/infocenter/new/topmenu.tpl:19: {$_modx->makeUrl(5036)} */
 echo $var["_modx"]->makeUrl(5036); ?>">Оценка</a></li>
                    <li><a href="<?php
/* file:chunks/infocenter/new/topmenu.tpl:20: {$_modx->makeUrl(5076)} */
 echo $var["_modx"]->makeUrl(5076); ?>">Экспертиза учета</a></li>
                    <li><a href="<?php
/* file:chunks/infocenter/new/topmenu.tpl:21: {$_modx->makeUrl(5076)} */
 echo $var["_modx"]->makeUrl(5076); ?>">Дью дилидженс</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-xs-8 hidden-print infocenterMenuWrapper">
            <div>
                    ...
                    <ul class="menu_top">
                        ...
                        <li class="item-117 deeper parent"><span class="separator">Услуги</span>
                            <ul>
                                ...
                                <li class="item-183">
                                    <a href="/nezavisimaya-ocenka" >Оценка</a>
                                </li>
                            </ul>
                        </li>
                        <li class="item-101"><a href="<?php
/* file:chunks/infocenter/new/topmenu.tpl:89: {$_modx->makeUrl(5336)} */
 echo $var["_modx"]->makeUrl(5336); ?>" >О компании</a></li>
                        <li class="item-258 deeper parent"><a href="<?php
/* file:chunks/infocenter/new/topmenu.tpl:90: {$_modx->makeUrl(5009)} */
 echo $var["_modx"]->makeUrl(5009); ?>" >Инфо-центр</a>
                            <ul>
                                <li class="item-257">
	...
	'options' => 160,
	'provider' => 'file',
	'name' => 'file:chunks/infocenter/new/topmenu.tpl',
	'base_name' => 'chunks/infocenter/new/topmenu.tpl',
	'time' => 1491482635,
	'depends' => array (
  'file' => 
  array (
    'chunks/infocenter/new/topmenu.tpl' => 1491482635,
  ),
),
	'macros' => array(),
